...
MIGRATION_MODULES = {"sites": "doi_portal.contrib.sites.migrations"}
...
ADMINS = [("""Mihas""", "admin@doi-portal.example.com")]
...
# https://docs.allauth.org/en/latest/account/configuration.html
ACCOUNT_EMAIL_VERIFICATION = "none"  # Interni korisnici, admini kreiraju naloge
# https://docs.allauth.org/en/latest/account/configuration.html
ACCOUNT_ADAPTER = "doi_portal.users.adapters.AccountAdapter"
# https://docs.allauth.org/en/latest/account/forms.html
ACCOUNT_FORMS = {"signup": "doi_portal.users.forms.UserSignupForm"}
# https://docs.allauth.org/en/latest/socialaccount/configuration.html
SOCIALACCOUNT_ADAPTER = "doi_portal.users.adapters.SocialAccountAdapter"
# https://docs.allauth.org/en/latest/socialaccount/configuration.html
SOCIALACCOUNT_FORMS = {"signup": "doi_portal.users.forms.UserSocialSignupForm"}
